package net.minecraftplus.base;
...
@Mod(modid = MCP.MCPID + ModBase.MODID, version = ModBase.VERSION, dependencies = "required-after:" + MCP.MODID)
public class ModBase extends MCP
{
