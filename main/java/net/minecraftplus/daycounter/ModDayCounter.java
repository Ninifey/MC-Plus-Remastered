...
@Mod(modid = MCP.MCPID + ModDayCounter.MODID, version = ModDayCounter.VERSION, dependencies = "required-after:" + MCP.MODID)
public class ModDayCounter extends MCP
{
	public static final String MODID = "daycounter";
	public static final String VERSION = "1.1.3";

	@Instance(MCP.MCPID + MODID)
	public static ModDayCounter INSTANCE;
